...
| :information_source: |  All helper nodes use `UTF-8` for the content encoding. If you want to use another charset, you can't use the helper node at the moment and have to customize your email as showed above. |
|:--|:--|
### Customized email
